...
function buildRadar ( obj, id, cardIndex, elIndex ) {
  console.log(obj);
  console.log(id);
  ...
  var rmargin = {
    ...
    rwidth = Math.min(700, window.innerWidth - 10) - rmargin.left - rmargin.right,
    rheight = Math.min(rwidth, window.innerHeight - rmargin.top - rmargin.bottom - 20);
  ...
  var cfg = {
        w: rwidth, //Width of the circle
        h: rheight, //Height of the circle
        margin: rmargin, //The margins of the SVG
    ...
    var cardWidth = window.width * 0.33333;
    cfg.w = cardWidth;
    cfg.h = cardWidth;
    ...
    var allAxis = (radarData[0].map(function(i, j) {
        ...
        radius = Math.min((cfg.w - cfg.margin.left - cfg.margin.right) / 2, cfg.h - cfg.margin.top - cfg.margin.bottom / 2), //Radius of the outermost circle
    ...
    var svg = d3.select('#card' + cardIndex).append("svg")
